import { TIPO_GENERO, TIPO_ESCOLARIDADE, ROLE_USUARIO, UserProfile } from './../../../../models/user.model';
...
@Component({
  selector: 'app-jovens-create',
  templateUrl: './jovens-create.component.html',
})
export class JovensCreateComponent implements OnInit {
