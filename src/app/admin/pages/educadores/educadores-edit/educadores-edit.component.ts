...
import { TIPO_GENERO, TIPO_ESCOLARIDADE, UserProfile } from 'src/app/models/user.model';
import { UsersService } from 'src/app/services/users.service';

@Component({
  selector: 'app-educadores-edit',
  templateUrl: './educadores-edit.component.html'
})
export class EducadoresEditComponent implements OnInit {
    ...
    if (this.angForm.valid) {
      ...
      if(this.angForm.value.uf !== null && this.angForm.value.uf !== '') {
        ...
        this.usersService.editUser(this.angForm.value).subscribe(result => {
          this.showloading = !this.showloading
          if(result == null) {
            this.router.navigate(['/admin/educadores']);
          }
